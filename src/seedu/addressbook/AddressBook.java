...
public class AddressBook {
	...
	private static String executeAddPerson(String commandArgs) {
		 ...
		 * decodeResult.get()[0]); personToAdd.put(PERSON_PROPERTY_PHONE,
		 * decodeResult.get()[1]);
		 * personToAdd.put(PERSON_PROPERTY_EMAIL,decodeResult.get()[2]);
		 */
	...
	// getMessageForPersonsDisplayedSummary(ArrayList<String[]>
	// personsDisplayed) {
	 ...
	 */
	/*
	 * private static Set<String> extractKeywordsFromFindPersonArgs(String
	 * findPersonCommandArgs) { return new
	 * HashSet<>(splitByWhitespace(findPersonCommandArgs.trim())); }
	 */
	 ...
	 * final ArrayList<String[]> matchedPersons = new ArrayList<>(); for
	 * (String[] person : getAllPersonsInAddressBook()) { final Set<String>
	 * wordsInName = new
	 * HashSet<>(splitByWhitespace(getNameFromPerson(person))); if
	 ...
	 */
	/*
	 * private static String getMessageForSuccessfulDelete(String[]
	 * deletedPerson) { return String.format(MESSAGE_DELETE_PERSON_SUCCESS,
	 ...
	 * showToUser(toBeDisplayed); return
	 ...
	 */
	/*
	 * private static void showToUser(ArrayList<String[]> persons) { String
	 * listAsString = getDisplayString(persons); showToUser(listAsString);
	 ...
	 */
	/*
	 * private static void updateLatestViewedPersonListing(ArrayList<String[]>
	 * newListing) { // clone to insulate from future changes to arg list
	 ...
	 * decodePersonsFromStrings(getLinesInFile(filePath)); if
	 * (!successfullyDecoded.isPresent()) {
	 ...
	 */
	/*
	 * private static void savePersonsToFile(ArrayList<String[]> persons, String
	 * filePath) { final ArrayList<String> linesToWrite =
	 * encodePersonsToStrings(persons); try {
	 * Files.write(Paths.get(storageFilePath), linesToWrite); } catch
	 * (IOException ioe) {
	 ...
	 * { final boolean changed = ALL_PERSONS.remove(exactPerson); if (changed) {
	 * savePersonsToFile(getAllPersonsInAddressBook(), storageFilePath); }
	 * return changed; }
	 */
	 ...
	 */
	/*
	 * private static void clearAddressBook() { ALL_PERSONS.clear();
	 * savePersonsToFile(getAllPersonsInAddressBook(), storageFilePath); }
	 */
	 ...
	 */
	/*
	 * private static void initialiseAddressBookModel(ArrayList<String[]>
	 ...
	 */
	/*
	 * private static String encodePersonToString(String[] person) { return
	...
	/*
	 * private static ArrayList<String>
	 * encodePersonsToStrings(ArrayList<String[]> persons) { final
	 * ArrayList<String> encoded = new ArrayList<>(); for (String[] person :
	 ...
	 * decodePersonsFromStrings(ArrayList<HashMap<String,String>>
	 * encodedPersons) { final ArrayList<HashMap<String,String>> decodedPersons
	 * = new ArrayList<>(); for (HashMap<String, String> encodedPerson :
	 * encodedPersons) { final Optional<HashMap<String,String>> decodedPerson =
	 * decodePersonFromString(encodedPerson); if (!decodedPerson.isPresent()) {
	 * return Optional.empty(); } decodedPersons.add(decodedPerson.get()); }
	 * return Optional.of(decodedPersons); }
	 */
	 ...
	 */
	/*
	 * private static boolean isPersonDataValid(String[] person) { private
	 * static boolean isPersonDataValid(HashMap<String,String> person) { return
	 * isPersonNameValid(person[PERSON_DATA_INDEX_NAME]) &&
